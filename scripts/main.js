...
(function() {
  var arc, arcTween, breadcrumb, classes, colors, height, heightRoot, onClick, partition, path, radius, svg, tooltip, width, widthRoot, x, y;
  ...
  d3.json('data/example.json', function(error, root) {
    ...
    }).on('click', onClick).on('mouseover', tooltip.show).on('mousemove', tooltip.update).on('mouseout', tooltip.hide).each(function(d) {
      if (d.depth === 0) {
